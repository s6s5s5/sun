...
public class ReflectionUtils {
	...
	public static void makeAccessible(Method method) {
		boolean type = (!Modifier.isPublic(method.getModifiers()) || !Modifier.isPublic(method.getDeclaringClass().getModifiers()))
				&& !method.isAccessible();
		if (type) {
	...
	public static void makeAccessible(Field field) {
		boolean type = (!Modifier.isPublic(field.getModifiers()) || !Modifier.isPublic(field.getDeclaringClass().getModifiers()) || Modifier
